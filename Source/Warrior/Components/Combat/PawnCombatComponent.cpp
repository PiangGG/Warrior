                                                 ...
                                                 AWarriorWeaponBase* InWeaponToRegister, bool bRegisterAsEquippedWeapon)
{
	...
	const FString WeaponString = FString::Printf(TEXT("A Weapon named: %s has been registered using the tag %s"),*InWeaponToRegister->GetName(),*CurrentEquippedWeaponTag.ToString());
